...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2024 at 05:57 PM
...
INSERT INTO `community` (`communityId`, `sender_name`, `sender_email`, `subject_bday`, `subject_gender`, `text_message`, `datecreated`, `dateupdated`) VALUES
(1, 'Joy Njeru', 'joy@lala.com', '2022-11-30', 'Female', '  here we are', '2024-07-06 18:48:07', '2024-07-06 18:48:07'),
(2, 'Muthoni', 'lili@jinks.com', '2009-02-03', 'Female', 'omg its finally working', '2024-07-06 18:53:01', '2024-07-06 18:53:01');
...
--
ALTER TABLE `community`
  MODIFY `communityId` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
